   ...
   <div class="collapse navbar-collapse" id="navbarsExample04">
      ...
      <ul class="menulist" id="listMenuRoot">
         <li class="nav-item active">
            <a class="nav-link" href="adminhome.php">Homepage</a>
         </li>         
         <li class="nav-item">
            <a class="nav-link" href="aabout.php">About Us</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" href="agallery.php">Gallery</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" href="avreviews.php">Reviews</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" href="smsg.php">Message</a>
         </li>
         <li>
             <a href="#" id="rr" style="width:75px;">Task</a>
             <ul>
                 <li><a href="newstudent.php">Students</a></li>   
                 <li><a href="aattendance.php">Attendance</a></li>   
                 <li><a href="amark.php">Mark</a></li>
             </ul>
         </li>
         <li class="nav-item">
...
<div id="about" class="about" style="min-height: 400px;">
 <div class="container">
